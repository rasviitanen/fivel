defmodule Fivel.EssenceAlphas do
  ...
  def add_essence_state(alpha, %{"essence_state" => essence_state_params}) do
    ...
    essence_state
      ...
      |> Fivel.EssenceStates.add_patterns_requirements_conceived(alpha.name)
      |> Fivel.EssenceStates.add_patterns_requirements_bounded(alpha.name)
      |> Fivel.EssenceStates.add_patterns_requirements_coherent(alpha.name)
      |> Fivel.EssenceStates.add_patterns_requirements_acceptable(alpha.name)
      |> Fivel.EssenceStates.add_patterns_requirements_addressed(alpha.name)
      |> Fivel.EssenceStates.add_patterns_requirements_fulfilled(alpha.name)
      |> Fivel.EssenceStates.add_patterns_software_system_architecture_selected(alpha.name)
      |> Fivel.EssenceStates.add_patterns_software_system_demonstrable(alpha.name)
      |> Fivel.EssenceStates.add_patterns_software_system_usable(alpha.name)
      |> Fivel.EssenceStates.add_patterns_software_system_ready(alpha.name)
      |> Fivel.EssenceStates.add_patterns_software_system_operational(alpha.name)
      |> Fivel.EssenceStates.add_patterns_software_system_retired(alpha.name)
      |> Fivel.EssenceStates.add_patterns_team_seeded(alpha.name)
      |> Fivel.EssenceStates.add_patterns_team_formed(alpha.name)
      |> Fivel.EssenceStates.add_patterns_team_collaborating(alpha.name)
      |> Fivel.EssenceStates.add_patterns_team_performing(alpha.name)
      |> Fivel.EssenceStates.add_patterns_team_adjourned(alpha.name)
      |> Fivel.EssenceStates.add_patterns_work_initiated(alpha.name)
      |> Fivel.EssenceStates.add_patterns_work_prepared(alpha.name)
      |> Fivel.EssenceStates.add_patterns_work_started(alpha.name)
      |> Fivel.EssenceStates.add_patterns_work_under_control(alpha.name)
      |> Fivel.EssenceStates.add_patterns_work_concluded(alpha.name)
      |> Fivel.EssenceStates.add_patterns_work_closed(alpha.name)
      |> Fivel.EssenceStates.add_patterns_way_of_working_principles_established(alpha.name)
      |> Fivel.EssenceStates.add_patterns_way_of_working_foundation_established(alpha.name)
      |> Fivel.EssenceStates.add_patterns_way_of_working_in_use(alpha.name)
      |> Fivel.EssenceStates.add_patterns_way_of_working_in_place(alpha.name)
      |> Fivel.EssenceStates.add_patterns_way_of_working_working_well(alpha.name)
      |> Fivel.EssenceStates.add_patterns_way_of_working_retired(alpha.name)
  end
